...
Cricket(String name, int age, String country, int matchesPlayed, int jerseynumber, int totalruns,
...
public class TestPlayer {
	...
	
	{
		...
		Cricket C1 = new Cricket("Suyash",21,"India", 103,2,5000,300,"Frontlever","Spinner");
		...
		FootBall f1 = new FootBall("Sayali",27,"India",106,2,100,"Frontdefender");	
